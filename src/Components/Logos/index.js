...
class Logos extends Component {
  ...
  <div><img className="the-logos" src={cube} alt="" /></div>
    <div><img className="the-logos" src={tw} alt="" /></div>
  <div><img className="the-logos" src={astonish} alt="" /></div>
  <div><img className="the-logos" src={bside} alt="" /></div>
  <div><img className="the-logos" src={hippodrome} alt="" /></div>
    <div><img className="the-logos" src={ace} alt="" /></div>
  <div><img className="the-logos" src={cwg} alt="" /></div>
    <div><img className="the-logos" src={nae} alt="" /></div>
      <div><img className="the-logos" src={pmg} alt="" /></div>

  <div><img className="the-logos" src={peggy} alt="" /></div>
  <div><img className="the-logos" src={selfridges} alt="" /></div>
  <div><img className="the-logos" src={sorveiv} alt="" /></div>
  <div><img className="the-logos" src={punch} alt="" /></div>
  <div><img className="the-logos" src={ted} alt="" /></div>
<div><img className="the-logos" src={mp} alt="" /></div>
  <div><img className="the-logos" src={mu} alt="" /></div>
  <div><img className="the-logos" src={keychange} alt="" /></div>
</div>
            <p>Shekayla Maragh is powered by Keychange - an international campaign led by Reeperbahn Festival, PRS Foundation and Musikcentrum Öst, supported by the Creative Europe Programme of the European Union, in partnership with Tallinn Music Week, Iceland Airwaves, BIME, Oslo World, Linecheck, Ireland Music Week, SACEM, Liverpool Sound City, Way Out West, Spring Break, MAMA, Mutek and Breakout West.”
